...
class GeminiGenerator:
    ...
    def _build_writing_prompt(self, coin: Dict[str, Any], research_package: str) -> str:
        ...
        parts = [
            ...
            "",
            "1. 80-110 WORDS. Count before finishing. STRICT: if under 80 words, quality gate will reject it.",
            ...
            "   - HASHTAGS: One line, 3-5 tags. MUST include #Write2Earn and at least 2 more relevant tags.",
            "",
            "RULES:",
